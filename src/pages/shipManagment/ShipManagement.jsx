...
import { getShipDailyAPI, getShipDataAPI, getShipInfoAPI } from "../../api/api";
...
function ShipManagement() {
  ...
  const { data: shipDaily } = useQuery(
    ["shipDaily", imoNumber],
    () => getShipDailyAPI(imoNumber),
    {
      enabled: !!imoNumber,
    }
  );
  ...
  return (
    <>
      <div className={`p-6 relative`}>
                ...
                <div className="mt-4 border-y-[1px] border-y-BEBEBE text-[14px]">
                  <div className="border-b-[1px] border-b-E3E3E3 font-medium flex">
                    ...
                    <div className="flex items-center justify-center p-2">
                      {parsedShipData && parsedShipData[0]?.ship_name}
                    </div>
                  </div>
                  <div className="border-b-[1px] border-b-E3E3E3 font-medium flex">
                    <div className="w-[55%] bg-F5F5F5 p-2">Ship Type</div>
                    <div className="flex items-center justify-center p-2">
                      {parsedShipData && parsedShipData[0]?.ship_type}
                    </div>
                  </div>
                  <div className="border-b-[1px] border-b-E3E3E3 font-medium flex">
                    <div className="w-[55%] bg-F5F5F5 p-2">IMO Number</div>
                    <div className="flex items-center justify-center p-2">
                      {parsedShipData && parsedShipData[0]?.imo_number}
                    </div>
                  </div>
                  <div className="border-b-[1px] border-b-E3E3E3 font-medium flex">
                    ...
                    <div className="flex items-center justify-center p-2">
                      {parsedShipData && parsedShipData[0]?.summer_load_dwt}
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="flex items-center justify-center p-2">
                      {parsedShipData && parsedShipData[0]?.gross_tonnage}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-20">
                ...
                <div className="mt-4 border-y-[1px] border-y-BEBEBE text-[14px]">
                  <div className="border-b-[1px] border-b-E3E3E3 font-medium flex">
                    ...
                    <div className="flex items-center justify-center p-2">
                      {parsedShipData &&
                        parsedShipData[0]?.total_distance_travelled}
                    </div>
                  </div>
              ...
              <div className="mt-20">
                ...
                <div className="mt-4 border-y-[1px] border-y-BEBEBE text-[14px]">
                  <div className="border-b-[1px] border-b-E3E3E3 font-medium flex">
                    ...
                    <div className="flex items-center justify-center p-2">
                      {parsedShipData && parsedShipData[0]?.required_cii}
                    </div>
                  </div>
                  <div className="border-b-[1px] border-b-E3E3E3 font-medium flex">
                    <div className="w-[45%] bg-F5F5F5 p-2">
                    ...
                    <div className="flex items-center justify-center p-2">
                      {parsedShipData && parsedShipData[0]?.attained_cii}
                    </div>
                  </div>
                  <div className="border-b-[1px] border-b-E3E3E3 font-medium flex">
                    <div className="w-[45%] bg-F5F5F5 p-2">CII 등급(Grade)</div>
                    <div className="flex items-center justify-center p-2">
                      {parsedShipData && parsedShipData[0]?.cii_grade}
                    </div>
                  </div>
                </div>
              </div>
        ...
        <MonitoringTable shipDaily={shipDaily} />
      </div>
    </>
  );
}
